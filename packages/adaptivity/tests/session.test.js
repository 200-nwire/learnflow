...
import { createSnapshot, updateAccuracyEWMA, updateLatencyEWMA, bumpIdle, setPreferenceTheme, } from '../src/index.js';
describe('Session Management', () => {
    ...
    describe('createSnapshot', () => {
        ...
        it('should preserve provided collections', () => {
            ...
            const sticky = { slot1: { variantId: 'v1', at: Date.now(), scope: 'lesson', strength: 'weak', reason: 'first_pick' } };
            const snapshot = createSnapshot({
                perSkill,
                sticky,
            });
    ...
    describe('updateLatencyEWMA', () => {
        ...
        it('should use custom clip values', () => {
            updateLatencyEWMA(session, 500, 0.8, { min: 400, max: 600 });
            expect(session.metrics.latencyEWMA).toBeGreaterThan(1900); // Moving toward 500
        });
    });
    describe('bumpIdle', () => {
