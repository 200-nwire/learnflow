...
import { SignalFactory, SignalBuffer, createSnapshot, selectVariant, } from '../src/index.js';
describe('Signal System', () => {
    ...
    describe('SignalFactory', () => {
        ...
        it('should create answer submitted signal', () => {
            const signal = factory.createAnswerSubmittedSignal(session, 'quiz_slot', 'easy_quiz', 'q1', true, 2500, 1, { choice: 'A' });
        ...
        it('should create page navigated signal', () => {
            const signal = factory.createPageNavigatedSignal(session, 'page_1', 'page_2', 'next', 15000);
        ...
        it('should create generic signal', () => {
            const signal = factory.createGenericSignal('user_interaction', session, { action: 'click', target: 'button_1' });
    ...
    describe('Signal Integration', () => {
        it('should create complete workflow signals', () => {
            ...
            // Answer submission
            const answerSignal = factory.createAnswerSubmittedSignal(session, 'intro_slot', 'v1', 'q1', true, 3000, 1, { answer: 'correct' });
            buffer.push(answerSignal);
            // Page navigation
            const navSignal = factory.createPageNavigatedSignal(session, 'page_1', 'page_2', 'next', 10000);
